...
/// لا يجرّد إلا القارئ) ⇒ فكلُّ مستخدمٍ يُسنَد لشركة كان ينال رواتبها ما لم ينتبه المسؤول
/// ويُلغِ التأشير. وحارسُ `All = 127` في الخادم يحمي المسار الذي **لا يرسل فيه العميل
/// شيئاً** — والواجهة ترسل كل شيء دائماً، فالتفّت عليه.
///
/// ⇒ **كل قسمٍ يُضاف مستقبلاً خارج `AppModule.All` يجب أن يبقى خارج هذه القائمة أيضاً.**
const List<String> kDefaultModules = [
  'Outgoing', 'Incoming', 'Archive', 'Reports', 'Users', 'Settings', 'Backup',
];
