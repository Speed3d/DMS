...
/// Hint: شاشة تعديل مسودة صادر
class OutgoingEditDraftScreen extends ConsumerStatefulWidget {
  final OutgoingDetail book;
  const OutgoingEditDraftScreen({super.key, required this.book});
  @override
  ConsumerState<OutgoingEditDraftScreen> createState() => _OutgoingEditDraftScreenState();
}

class _OutgoingEditDraftScreenState extends ConsumerState<OutgoingEditDraftScreen> {
