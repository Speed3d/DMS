...
**بإيجاز (2026-07-29):** ✅ Phase 0/1/2 مكتملة — **تسع وحدات** تعمل: الصادر · الوارد · **الأقسام** · الأرشيف · المستخدمون والصلاحيات · التقارير المالية · النسخ الاحتياطي والاستعادة · وضع دون اتصال · الأمان والتدقيق.
البناء **0/0**، و**124 اختبار وحدة**، و**20 اختبار واجهة**، و**147 تحقّق E2E**. **معايير قبول v1: 10/10.**
