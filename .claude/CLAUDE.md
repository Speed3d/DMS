...
**بإيجاز (2026-07-25):** ✅ Phase 0/1/2 مكتملة — **تسع وحدات** تعمل: الصادر · الوارد · **الأقسام** · الأرشيف · المستخدمون والصلاحيات · التقارير المالية · النسخ الاحتياطي والاستعادة · وضع دون اتصال · الأمان والتدقيق.
البناء **0/0**، و**65 اختبار وحدة**، و**91 تحقّق E2E** (68 وارد + 13 نسخ/استعادة + 10 أقسام). **معايير قبول v1: 10/10.**
...
أعمال برمجية غير مانعة: مثبّت ويندوز `.exe` · اختبارات العزل والتزامن · بقية التقارير.
