...
✅ **الوحدة العاشرة — الموظفون والرواتب (كاملة بدفعتيها):** باك-إند + ٨ شاشات + الإجازات وسجلّ التغييرات ونهاية الخدمة + E2E 54/54 (ADR-023 + ADR-024). **مدموجة في `main` والمهاجرتان مُطبَّقتان على `DmsDb`** ومُتحقَّق منهما حيّاً. ⚠️ **لم تُرفَع إلى `origin` بعد.**
البناء **0/0**، و**193 اختبار وحدة**، و**34 اختبار واجهة**، و**201 تحقّق E2E**. **معايير قبول v1: 10/10.**
