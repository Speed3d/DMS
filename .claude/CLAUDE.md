...
🚧 **وحدة عاشرة قيد البناء — الموظفون والرواتب:** الباك-إند مكتمل ومُختبَر حيّاً (ADR-023 + ADR-024)، والواجهة لم تبدأ. على فرع `claude/payroll-management-plan-review-3e8004` **غير مدموج**، والمهاجرة **لم تُطبَّق على `DmsDb`**.
البناء **0/0**، و**182 اختبار وحدة**، و**20 اختبار واجهة**، و**147 تحقّق E2E**. **معايير قبول v1: 10/10.**
