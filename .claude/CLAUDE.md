...
**بإيجاز (2026-08-03):** ✅ Phase 0/1/2 مكتملة — **تسع وحدات** تعمل: الصادر · الوارد · **الأقسام** · الأرشيف · المستخدمون والصلاحيات · التقارير المالية · النسخ الاحتياطي والاستعادة · وضع دون اتصال · الأمان والتدقيق.
✅ **وحدة عاشرة — الموظفون والرواتب (الدفعة ١ كاملة):** باك-إند + ٦ شاشات + E2E 36/36 (ADR-023 + ADR-024). على فرع `claude/payroll-management-plan-review-3e8004` **غير مدموج**، والمهاجرة **لم تُطبَّق على `DmsDb`**. الدفعة ٢ (الإجازات · نهاية الخدمة) مؤجَّلة بقرار.
البناء **0/0**، و**182 اختبار وحدة**، و**31 اختبار واجهة**، و**183 تحقّق E2E**. **معايير قبول v1: 10/10.**
