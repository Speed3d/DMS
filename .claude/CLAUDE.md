...
**بإيجاز (2026-07-27):** ✅ Phase 0/1/2 مكتملة — **تسع وحدات** تعمل: الصادر · الوارد · **الأقسام** · الأرشيف · المستخدمون والصلاحيات · التقارير المالية · النسخ الاحتياطي والاستعادة · وضع دون اتصال · الأمان والتدقيق.
البناء **0/0**، و**80 اختبار وحدة**، و**13 اختبار واجهة**، و**133 تحقّق E2E**. **معايير قبول v1: 10/10.**
الإحالة صارت **متعددة الأقسام وتراكمية** (ADR-018)، و**مَن أحال يبقى يرى**.
