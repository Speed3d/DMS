---
name: verify-backend
description: تشغيل اختبار التدفق الشامل (E2E) لباك-إند DMS عبر الـ API الحيّ للتأكد من سلامة دورتَي الصادر والوارد. استخدمها بعد تغييرات مهمة في الباك-إند أو للتحقق من أن النظام يعمل end-to-end.
---
