...
- **وحدة الوارد — المرحلة ج (تصلّب وأمان):**
  ...
  - **ج3 (بانتظار قرار المالك):** قيد التعديل الحالي «الكتاب الجديد فقط»؛ الخطة تعطي المدير فأعلى حق التعديل في أي حالة عدا المؤرشف.
  - **تحقّق انحدار:** 61/61 على E2E بعد التغييرات.
