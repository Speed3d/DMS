...
public class UserCompany
{
    ...
    /// <summary>
    /// **يدير بطاقات الموظفين في هذه الشركة** — إضافةً وتعديلاً وإنهاءَ خدمةٍ وإجازاتٍ
    /// ومستمسكات (ADR-025).
    /// </summary>
    /// <remarks>
    /// نمط <see cref="CanApprove"/>: القسم (<see cref="AppModule.Employees"/>) يفتح
    /// **الرؤية**، وهذا العلَم يفتح **الكتابة**. فيرى مستخدمٌ بطاقاتِ الموظفين دون تعديلها.
    /// </remarks>
    public bool CanManageEmployees { get; set; }

    /// <summary>
    /// **يدير كشوف الرواتب في هذه الشركة** — توليداً وتحريراً وتسديداً وإيصالات (ADR-025).
    /// </summary>
    /// <remarks>
    /// ⚠️ **مفصولٌ عن <see cref="CanManageEmployees"/> بقرار المالك (2026-08-05):** مَن يُدخل
    /// بيانات الموظفين ليس بالضرورة مَن يصرف رواتبهم. علَمٌ واحد كان يعني أن كاتب شؤون
    /// الموظفين يملك تسديد الرواتب، وأن المحاسب يملك تعديل العقود — وكلاهما توسعةٌ لم يطلبها أحد.
    /// </remarks>
